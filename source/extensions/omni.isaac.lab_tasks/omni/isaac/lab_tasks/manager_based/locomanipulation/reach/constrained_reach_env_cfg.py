...
class RewardsCfg:
    ...
    leg_low_power = RewTerm(func=mdp.low_power, weight=0.5, params={"asset_cfg": SceneEntityCfg("robot", joint_names=[".*hip_joint", ".*thigh_joint", ".*calf_joint"]), "max_power": 900.0})
...
class ConstraintsCfg:
    ...
    cstr_min_base_height = CstrTerm(init_max_p=1.0, final_max_p=1.0, func=mdp.cstr_min_base_height,
                                    params={"min_height": 0.1, "asset_cfg": SceneEntityCfg("robot", body_names=[".*base"])})
    ...
    cstr_joint_deviation = CstrTerm(init_max_p=0.05, final_max_p=0.9, func=mdp.cstr_joint_deviation,
                                    params={"limit": 0.4, "asset_cfg": SceneEntityCfg("robot", joint_names=[".*hip_joint", ".*thigh_joint", ".*calf_joint"])})
    cstr_body_upper_height = CstrTerm(init_max_p=0.05, final_max_p=0.25, func=mdp.cstr_max_base_height,
                                    params={"max_height": 0.55, "asset_cfg": SceneEntityCfg("robot", body_names=[".*base"])})

    cstr_base_orientation = CstrTerm(init_max_p=0.05, final_max_p=0.9, func=mdp.cstr_flat_orientation,
