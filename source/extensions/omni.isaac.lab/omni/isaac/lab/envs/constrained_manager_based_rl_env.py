...
from omni.isaac.lab.managers import CommandManager, CurriculumManager, RewardManager, TerminationManager, ConstraintManager

from .common import VecEnvStepReturn
from .manager_based_env import ManagerBasedEnv
from .manager_based_rl_env import ManagerBasedRLEnv
from .constrained_manager_based_rl_env_cfg import ConstrainedManagerBasedRLEnvCfg 


class ConstrainedManagerBasedRLEnv(ManagerBasedEnv, gym.Env):
    ...
    cfg: ConstrainedManagerBasedRLEnvCfg
    """Configuration for the environment."""

    def __init__(self, cfg: ConstrainedManagerBasedRLEnvCfg, render_mode: str | None = None, **kwargs):
    ...
    def step(self, action: torch.Tensor) -> VecEnvStepReturn:
        ...
        7. Compute the constraints.
        8. Modify rewards and resets based on the constraint probabilities.
        9. Return the observations, rewards, resets and extras.
        ...
        reset_env_ids = self.reset_env_buf.nonzero(as_tuple=False).squeeze(-1)
